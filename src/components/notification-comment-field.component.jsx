...
const NotificationCommentField = ({ _id, blog_author, index = undefined, replyingTo = undefined, setReplying, notification_id, notificationData }) => {
    ...
    return (
        <>
            <Toaster />
            <textarea value={comment} placeholder="Leave a Reply..." className="input-box pl-5 placeholder:text-dark-grey resize-none h-[150px] overflow-auto0" onChange={(e) => setComment(e.target.value)} />
