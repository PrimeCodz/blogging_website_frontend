        ...
        <div className="w-full" style={{ paddingLeft: `${leftVal * 10}px` }}>
            <div className="my-5 p-6 rounded-md border border-grey">
                <div className="flex gap-3 items-center mb-8">
                    ...
                    <p className="min-w-fit">{getDates(commentedAt)}</p>
                </div>
                ...
                <div className="flex gap-5 items-center mt-5">
                    ...
                    {commentData.isReplyLoaded ?
                        ...
                        <button className="text-dark-grey p-2 px-3 sm:px-0 hover:bg-grey/30 rounded-md flex items-center gap-2" onClick={() => loadReplies({ currentIndex: index })}>
                            <i className="fi fi-rs-comment-dots" /> {children.length} Reply
                        </button>
                    }

                    <div className="flex gap-1 items-center" onClick={handleReplyClick}>
                        <i className="fi fi-rr-redo cursor-pointer" />
