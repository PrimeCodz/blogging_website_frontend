            ...
            <Link to={`/blog/${id}`} className="flex gap-8 items-center border-b border-grey pb-5 mb-4">
                <div className="w-full">
                    <div className="flex gap-2 items-center mb-7">
                        ...
                        <p className="min-w-fit">{getDates(publishedAt)}</p>
                    </div>
                    ...
                    <div className="flex items-center gap-4 mt-7">
                        ...
                        <span className="ml-3 flex items-center gap-2 text-dark-grey"><i className="fi fi-rr-heart text-xl" />{total_likes}</span>
                    </div>
                </div>
                <div className="h-28 aspect-square bg-grey">
                    <img src={banner} className="w-full h-full object-cover aspect-square"/>
                </div>
            </Link>
        </>
    )
