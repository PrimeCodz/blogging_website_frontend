...
const EditProfile = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if(username.length < 3){
            return toast.error("Username Must Be Atleast 3 Letters Long");
        }
                    ...
                    <form ref={editProfileForm}>
                        ...
                        <div className="flex flex-col lg:flex-row items-start py-10 gap-8 lg:gap-10">
                            ...
                            <div className="max-lg:center mb-5">
                                ...
                                <button className="mt-5 btn-light max-lg:center lg:w-full px-10 hover:bg-black/30" onClick={handleImgUpload}>Upload</button>
                            </div>
                            ...
                            <div className="w-full">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 md:gap-5">
                                    <div>
                                        <InputBox name="fullname" type="text" value={fullname} placeholder="Enter Full Name" disable={true} icon="fi-rr-user" />
                                    </div>
                                    <div>
                                        <InputBox name="email" type="email" value={email} placeholder="Enter Your Email Id" disable={true} icon="fi-rr-envelope" />
                                    </div>
                                </div>

                                <InputBox name="username" type="text" value={profile_username} placeholder="Enter Your Username" icon="fi-rr-at" />
                                <p className="text-dark-grey -mt-3">* Username will be use to search user and will be visible to all users</p>
                                <textarea name="bio" maxLength={bioLimit} placeholder="Write Something About You...." defaultValue={bio} className="input-box h-64 lg:h-40 resize-none leading-7 mt-5 pl-5" onChange={handleCharacterChange} />
                                <p className="mt-1 text-dark-grey">{charactersLeft} Characters Left</p>

                                <p className="py-6 text-dark-grey">Add Your Social Links Below</p>
